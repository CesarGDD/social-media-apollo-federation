...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) ([]fedruntime.Entity, error) {
	...
	for _, rep := range representations {
		...
		case "HashtagPost":
			id0, err := ec.unmarshalNInt2int(ctx, rep["post_id"])
			if err != nil {
				return nil, errors.New(fmt.Sprintf("Field %s undefined in schema.", "post_id"))
			}

			entity, err := ec.resolvers.Entity().FindHashtagPostByPostID(ctx,
				id0)
			if err != nil {
				return nil, err
			}
